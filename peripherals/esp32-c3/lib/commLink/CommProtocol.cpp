// Byte-for-byte the same logic as Car_Dashboard/src/CommProtocol.cpp — only the
// include path differs (the header sits alongside this file in the PlatformIO lib).
